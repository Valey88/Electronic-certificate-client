...
export default function ReturnPolicy() {
  const [content, setContent] = useState({
    ...
    "meta-description": "Узнайте о нашей политике возврата товаров и условиях возврата.",
  ...
  return (
    <div className="bg-gray-50 py-8">
      <Helmet>
        ...
        <link
          rel="canonical"
          href={content["canonical-link"] || "https://www.yourwebsite.com/return-policy"}
        />
      </Helmet>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-8">
          ...
          />
          <div className="w-1/2 mx-auto my-4 border-t-2 border-teal-500" />
        </header>
        <div className="mb-8 prose prose-lg max-w-none text-gray-700">
          <div
            dangerouslySetInnerHTML={{
        ...
        <div className="space-y-10">
          <div
            className="text-2xl md:text-3xl font-semibold text-teal-600 text-center"
            dangerouslySetInnerHTML={{
              __html: content["sub-heading"] || "<h2>Изделия надлежащего качества</h2>",
            }}
          />
          <div
          ...
          <div className="space-y-6">
            <details className="bg-teal-100 rounded-lg shadow-md">
              <summary className="flex items-center justify-between px-6 py-4 text-lg font-medium text-teal-900 cursor-pointer hover:bg-teal-200 transition-colors duration-200">
                {stripHtml(
              ...
              <div className="px-6 py-4 max-h-96 overflow-auto bg-white rounded-b-lg">
            ...
            <details className="bg-teal-100 rounded-lg shadow-md">
              <summary className="flex items-center justify-between px-6 py-4 text-lg font-medium text-teal-900 cursor-pointer hover:bg-teal-200 transition-colors duration-200">
                {stripHtml(
                  content["accordion-2-title"] || "Возврат товара ненадлежащего качества"
                )}
                <svg
                  className="w-6 h-6 transform transition-transform duration-200"
                  fill="none"
